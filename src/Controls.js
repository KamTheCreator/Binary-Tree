class Controls {
    ...
    static DELETEID = "delete-btn"; // New constant for delete button
    ...
    constructor(tree) {
        ...
        this.deleteBtn = document.getElementById(Controls.DELETEID); // New button
        ...
        this.deleteBtn.addEventListener('click', // Add event listener for delete button
            () => this.triggerAnimation(this.deleteNode));
    ...
    //          positive integer    => if a valid positive integer is provided
    getNumber(text) {
    ...
    deleteNode() {
        var value = this.getNumber("Value to delete: ");
